<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $resultado = $connect->query("SELECT * FROM tecnicos WHERE id = $id")->fetchAll(PDO::FETCH_ASSOC);
    ...
    <body>
        ...
        <div class="main-container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo PUBLIC_PATH ?>/tecnico/<?= $modo ?>.php" method="post">
                        <?php if ($modo == 'actualizar') {
                         ...
                         <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="especialidad" name="especialidad" value="<?= $data['especialidad']?>" required>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="cargo" name="cargo" value="<?= $data['cargo']?>">
                            </div>
                        </div>
