<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $resultado = $connect->query("SELECT * FROM propietarios WHERE id = $id")->fetchAll(PDO::FETCH_ASSOC);
    ...
    <body>
        ...
        <div class="main-container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo PUBLIC_PATH ?>/propietario/<?= $modo ?>.php" method="post">
