<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $resultado = $connect->query("SELECT * FROM grupos WHERE id = $id")->fetchAll(PDO::FETCH_ASSOC);
...
<html>
    <head>
        ...
        <script src="<?php echo PUBLIC_PATH ?>/grupo/main.js"></script>
    </head>
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="main-container">
            <div class="box">
                ...
                <div class="box-body">
                    <form action="<?php echo PUBLIC_PATH ?>/grupo/<?= $modo ?>.php" method="post">
