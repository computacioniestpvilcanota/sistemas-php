<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $resultado = $connect->query("SELECT * FROM autores WHERE id = $id")->fetchAll(PDO::FETCH_ASSOC);
...
<html>
    <head>
        ...
        <script src="<?php echo PUBLIC_PATH ?>/autor/main.js"></script>
    </head>
    <body>
        ...
        <div class="main-container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo PUBLIC_PATH ?>/autor/<?= $modo ?>.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" value="<?= $data['nacionalidad']?>" required>
                            </div>
                        </div>
