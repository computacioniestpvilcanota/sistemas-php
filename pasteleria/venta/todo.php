<?php
    ...
    try {
        $resultado = $connect->query('SELECT ventas.id, ventas.cantidad, ventas.precio, ventas.fecha_venta, productos.nombre as producto, empleados.nombres as empleado, clientes.nombres as cliente FROM ventas
