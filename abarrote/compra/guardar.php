<?php
    ...
    try {
        ...
        $statementProducto =  $connect->prepare("UPDATE productos SET stock=:stock, precio=:precio, fecha_vencimiento=:fecha_vencimiento WHERE id =:id ");

        // Ejecutando la consulta
        $nuevoStock = intval($_POST['cantidad']) + intval($producto['stock'] );
