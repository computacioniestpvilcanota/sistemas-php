<?php
    ...
    try {
        $resultado = $connect->query('SELECT reservaciones.id, reservaciones.fecha, reservaciones.fecha_reserva, reservaciones.hora_reserva, reservaciones.abservacion, reservaciones.precio, clientes.nombres as cliente, peliculas.nombre as pelicula FROM reservaciones
