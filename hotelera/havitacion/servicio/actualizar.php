<?php
    ...
    try {
        ...
        $statement =  $connect->prepare("UPDATE servicios SET  
        ...
        if(!$_FILES['foto']['tmp_name'] == ''){
            // Actualizar la foto
            $statementFile =  $connect->prepare("UPDATE servicios SET foto=:foto WHERE id=:id");
        ...
        header('location:' . PUBLIC_PATH . '/servicio');
