<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $resultado = $connect->query("SELECT * FROM insumos WHERE id = $id")->fetchAll(PDO::FETCH_ASSOC);
...
<html>
    <head>
        ...
        <script src="<?php echo PUBLIC_PATH ?>/insumo/main.js"></script>
    </head>
    <body>
        ...
        <div class="main-container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo PUBLIC_PATH ?>/insumo/<?= $modo ?>.php" method="post">
