<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $resultado = $connect->query("SELECT * FROM marcas WHERE id = $id")->fetchAll(PDO::FETCH_ASSOC);
...
<html>
    <head>
        ...
        <script src="<?php echo PUBLIC_PATH ?>/marca/main.js"></script>
    </head>
    <body>
        ...
        <div class="main-container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo PUBLIC_PATH ?>/marca/<?= $modo ?>.php" method="post">
