<?php
    ...
    try {
        $resultado = $connect->query('SELECT ventas.id, ventas.cantidad, ventas.precio, ventas.fecha_venta, menus.nombre as menu, empleados.nombres as empleado, clientes.nombres as cliente FROM ventas
