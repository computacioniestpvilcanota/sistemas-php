<?php
    ...
    try {
        $resultado = $connect->query('SELECT compras.id, compras.cantidad, compras.precio, compras.fecha_compra, medicinas.nombre as medicina, empleados.nombres as empleado, proveedores.rason_social as proveedor FROM compras
        INNER JOIN medicinas ON medicinas.id = compras.id_medicina
